export default {
  navigation: [
    {
      groupTitle: 'Карта SORA',
      links: [
        { title: 'Магчымасці', href: '/#features' },
        { title: 'Інтэграцыі', href: '/integrations' },
        { title: 'Зарабляйце', href: '/earn' },
        { title: 'Тарыфы', href: '/fees' },
        { title: 'Блог', href: '/blog' },
        { title: 'Рэфералы', href: '/referrals', label: 'скора' },
        { applyButton: 'Падаць заяўку' },
      ],
    },
    {
      groupTitle: 'Аб',
      links: [
        { title: 'Міжнародная місія', href: '/vision' },
        { title: 'SORAnomics', href: '/soranomics' },
        { title: 'Тэхналогіі', href: '/technology' },
        { title: 'Амбасадары', href: '/ambassadors' },
    ...
    },
    {
      ...
      links: [
        { title: 'FAQ', href: '/#faq' },
        { title: 'Падтрымка', href: '/support/' },
        { title: 'Кантакт', href: '/contact' },
        { title: 'Запыт функцыі', href: '/request-feature' },
      ],
    },
    {
      groupTitle: 'Рэсурсы',
