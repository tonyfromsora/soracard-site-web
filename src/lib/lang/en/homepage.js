export default {
    ...
    "features": {
        ...
        "disclaimer": "*Currently SORA network with a bridge to Ethereum, Polkadot and Kusama, soon other EVM networks and Bitcoin"
    },
    "value": {
        "label": "Value Freedom",
    ...
    "faq": {
        ...
        "items": [
            ...
            },
            {
                ...
                "content": [
                    "You can top up your SORA Card using XOR ↔ EUR or SEPA (bank transfer)."
                ]
            },
            {
            ...
            {
                "title": "What security measures does SORA Card have in place to protect my funds and data?",
                "content": [
    ...
    "getCardBanner": {
        ...
        "description": "SORA card is a neobanking-style solution that gives direct access to decentralized and non-custodial crypto. SORA does not have access to your crypto assets or user data. We value freedom.",
